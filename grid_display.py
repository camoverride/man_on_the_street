...
def injector(
    ...
    """
    Continuously load random videos into the grid.
    ...
    grid : list
        Shared grid of video data.
    grid_w : int
        Number of grid columns.
    grid_h : int
        Number of grid rows.
    cell_w : int
        Width assigned to each grid column.
    num_canvas_frames : int
    ...
    while True:
        ...
        frames = load_video_frames(random.choice(videos))
        ...
        # Cache the scaled height so it does not need to be
